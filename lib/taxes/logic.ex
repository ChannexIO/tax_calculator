defmodule Taxes.Logic do
  ...
  def calculate_tax(%{title: title, rate: rate, logic: :per_person}, %{count_of_persons: count_of_persons}) do
    {title, rate * count_of_persons}
  end

  def calculate_tax(%{title: title, rate: rate, logic: :per_person_per_night}, %{count_of_nights: count_of_nights, count_of_persons: count_of_persons}) do
